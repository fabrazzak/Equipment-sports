...
const Login = () => {
    ...
    return (
        <div>
            ...
            <Helmet>
                <title> Login | Canada Career Counselling</title>
            </Helmet>
                    ...
                    <div className="card bg-base-100 md:w-96  shrink-0 shadow-2xl">
                        <form onSubmit={handleOnSubmit} className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                <label className="label">
                                    <Link to='/register' href="#" className="label-text-alt link link-hover text-green-700 font-bold ">Don't have account,Register Here</Link>
                                    <Link to='/forget' href="#" className="label-text-alt link link-hover text-green-700 font-bold ">Forgot password?</Link>
                                </label>
                            </div>
                            <div className="form-control mt-6 ">
                                <button className="btn btn-primary bg-green-700 text-white font-bold hover:bg-green-600  border-none">Login</button>
                            </div>
                        </form>
